...
const REQUEST_HEADER_WITH_CREDENTIAL = { headers: { "Content-Type":"application/json", "Accept":"application/json" }, origin: "https://localhost:8093" };
...
export default class HomePage extends Component {
    ...
    async componentDidMount() {
        let movies = await  customAxios.get('watchlist-service/v1/watchlist', REQUEST_HEADER_WITH_CREDENTIAL);
