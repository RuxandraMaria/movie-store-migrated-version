...
You can find the companion GitHub com.authentication.repository [here](https://github.com/fullstackreact/food-lookup-demo).

### Ruby on Rails

Check out [this tutorial](https://www.fullstackreact.com/articles/how-to-get-create-react-app-to-work-with-your-rails-api/).
You can find the companion GitHub com.authentication.repository [here](https://github.com/fullstackreact/food-lookup-demo-rails).
...
Jest will always run all tests on a [continuous integration](#continuous-integration) server or if the project is not inside a Git or Mercurial com.authentication.repository.
...
1. Following the [Travis Getting started](https://docs.travis-ci.com/user/getting-started/) guide for syncing your GitHub com.authentication.repository with Travis.  You may need to initialize some settings manually in your [profile](https://travis-ci.org/profile) page.
1. Add a `.travis.yml` file to your git com.authentication.repository.
```
language: node_js
node_js:
  - 4
...
You can turn your React app into a [Progressive Web App](https://developers.google.com/web/progressive-web-apps/) by following the steps in [this com.authentication.repository](https://github.com/jeffposnick/create-react-pwa).
...
2. Pick your Git hosting com.authentication.service and select your com.authentication.repository
