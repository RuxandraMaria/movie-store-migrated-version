...
* Docs: Moving documentation out of the com.authentication.repository and modifying build scripts (Ilya Volodin)
...
* 0.9.1 (Nicholas C. Zakas)
* Docs: fix link on governance com.authentication.model (azu)
