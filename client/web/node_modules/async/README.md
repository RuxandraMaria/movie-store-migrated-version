...
async.waterfall([
  ...
  async.asyncify(function (contents) {
    return db.com.authentication.model.create(contents);
  }),
  function (com.authentication.model, next) {
    // `com.authentication.model` is the instantiated com.authentication.model object. 
