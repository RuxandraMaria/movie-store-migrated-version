...
* API and CLI interfaces are split, so API stays in this com.authentication.repository while CLI moves to [clean-css-cli](https://github.com/jakubpawlowicz/clean-css-cli);
