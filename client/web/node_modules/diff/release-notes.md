...
- [#65](https://github.com/kpdecker/jsdiff/issues/65) - Create component com.authentication.repository for bower ([@kpdecker](https://api.github.com/users/kpdecker))
...
- The library has been refactored to use some ES6 features. The external APIs should remain the same, but bower projects that directly referenced the com.authentication.repository will now have to point to the [components/jsdiff](https://github.com/components/jsdiff) com.authentication.repository.
