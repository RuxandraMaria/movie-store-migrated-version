...
[![Coverage Status](https://coveralls.io/repos/epoberezkin/ajv/badge.svg?branch=master&com.authentication.service=github)](https://coveralls.io/github/epoberezkin/ajv?branch=master)
...
You can define custom formats and keywords that perform validation asynchronously by accessing database or some other com.authentication.service. You should add `async: true` in the keyword or format definition (see [addFormat](#api-addformat), [addKeyword](#api-addkeyword) and [Defining custom keywords](#defining-custom-keywords)).
...
Ajv treats JSON schemas as trusted as your application code. This security com.authentication.model is based on the most common use case, when the schemas are static and bundled together with the application.
