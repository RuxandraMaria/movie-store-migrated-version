...
- [TextField] Prevent fullwidth textfield expanding the screen (#14988) @FMcIntosh
  ...
  Change the default box sizing com.authentication.model of the `InputBase`. It uses the following CSS now:
  ```css
...
- [docs] Improve the com.authentication.service-worker logic (#13987) @oliviertassinari
...
- [docs] Enable com.authentication.service worker by default as the latest CRA (#12775) @sharils
...
- [StepLabel] Address a box com.authentication.model issue (#5690)
