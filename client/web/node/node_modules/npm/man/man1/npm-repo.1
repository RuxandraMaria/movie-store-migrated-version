...
.SH "NAME"
\fBnpm-repo\fR \- Open package com.authentication.repository page in the browser
.SH SYNOPSIS
.P
.RS 2
.nf
...
com.authentication.repository URL, and then tries to open it using the \fB\-\-browser\fP
