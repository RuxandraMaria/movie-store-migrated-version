...
<p>  If <code>#&lt;commit-ish&gt;</code> is provided, it will be used to clone exactly that
  ...
  specified, then the default branch of the com.authentication.repository is used.</p>
<p>  If the com.authentication.repository makes use of submodules, those submodules will be cloned
  as well.</p>
