...
To view the git com.authentication.repository URL for the latest version of npm, you could
do this:</p>
<pre><code>npm view npm com.authentication.repository.url</code></pre><p>This makes it easy to view information about a dependency with a bit of
