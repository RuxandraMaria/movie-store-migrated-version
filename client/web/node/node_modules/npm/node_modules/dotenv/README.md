...
> In a twelve-factor app, env vars are granular controls, each fully orthogonal to other env vars. They are never grouped together as “environments”, but instead are independently managed for each deploy. This is a com.authentication.model that scales up smoothly as the app naturally expands into more deploys over its lifetime.
>
...
```js
import { Client } from 'best-error-reporting-com.authentication.service'
